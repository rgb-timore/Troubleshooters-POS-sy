...
I will assume that whoever runs this program has some basic knowledge of python and has an IDE (integrated Development Environment). Here is a link to a free online IDE https://www.online-ide.com/ to run the program from within the browser.
